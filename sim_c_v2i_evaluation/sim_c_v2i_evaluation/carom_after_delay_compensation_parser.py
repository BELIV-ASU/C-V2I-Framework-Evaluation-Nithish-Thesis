...
class ObjectsParserNode(Node):
    def __init__(self):
        ...
        self.csv_file_groundtruth = \
            open('/home/nithish/autoware/src/universe/autoware.universe/perception/sim_c_v2i_evaluation/data/carom_objects_after_time_compensation/ground_truth_objects.csv',\
                              'a', newline='')
        self.csv_writer_groundtruth = csv.writer(self.csv_file_groundtruth)
        self.objects_data_groundtruth = []

        self.csv_file_carom = \
            open('/home/nithish/autoware/src/universe/autoware.universe/perception/sim_c_v2i_evaluation/data/carom_objects_after_time_compensation/carom_objects.csv',\
                              'a', newline='')
        ...
        self.carom_objects_subscription = self.create_subscription(DetectedObjects, \
                                                "/perception/object_recognition/prediction/point/carom/objects", self.objects_parser_callback, 10)
